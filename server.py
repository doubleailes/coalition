...
def authenticate(request, ldap_permissions):
    ...
    def _getLdapPermissions(connection, username):
        ...
        for permission in list(ldap_permissions.keys()):
    ...
    if LDAPServer:
        ...
        if (
            ...
            for k in list(ldap_permissions.keys()):
        ...
        with db:
            ...
            if request.path == "/workers/heartbeat":
                return self.json_heartbeat(
                    ...
                    getArg("log", ""),
                    getArg("load", "[0]"),
                    getArg("free_memory", "0"),
                    getArg("total_memory", "0"),
                    request.getClientIP(),
                )
...
if sys.platform == "win32":
    ...
    try:
        ...
        installDir, _type = winreg.QueryValueEx(hKey, "Installdir")
        dataDir, _type = winreg.QueryValueEx(hKey, "Datadir")
    except OSError:
        installDir = "."
        dataDir = "."
else:
